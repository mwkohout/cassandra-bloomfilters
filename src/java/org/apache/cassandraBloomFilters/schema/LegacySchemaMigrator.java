...
import static org.apache.cassandraBloomFilters.utils.FBUtilities.fromJsonMap;
...
public final class LegacySchemaMigrator
{
    ...
    static void unloadLegacySchemaTables()
    {
        ...
        LegacySchemaTables.forEach((cfm) -> org.apache.cassandraBloomFilters.db.Keyspace.openAndGetStore(cfm).invalidate());
    ...
    {
        ColumnFamilyStore store = org.apache.cassandraBloomFilters.db.Keyspace.open(SystemKeyspace.NAME)
