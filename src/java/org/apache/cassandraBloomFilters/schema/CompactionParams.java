...
import org.apache.cassandraBloomFilters.db.compaction.LeveledCompactionStrategy;
import org.apache.cassandraBloomFilters.db.compaction.SizeTieredCompactionStrategy;
...
public final class CompactionParams
{
    ...
    private static Class<? extends AbstractCompactionStrategy> classFromName(String name)
    {
        String className = name.contains(".")
                         ? name
                         : "org.apache.cassandraBloomFilters.db.compaction." + name;
