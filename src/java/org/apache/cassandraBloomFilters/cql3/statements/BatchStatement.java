...
public class BatchStatement implements CQLStatement
{
    ...
    public Iterable<org.apache.cassandraBloomFilters.cql3.functions.Function> getFunctions()
    {
        Iterable<org.apache.cassandraBloomFilters.cql3.functions.Function> functions = attrs.getFunctions();
