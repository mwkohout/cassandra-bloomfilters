...
import org.apache.cassandraBloomFilters.exceptions.AuthenticationException;
...
public interface IAuthenticator
{
     ...
     * @return org.apache.cassandraBloomFilters.auth.IAuthenticator.SaslNegotiator implementation
     * (see {@link org.apache.cassandraBloomFilters.auth.PasswordAuthenticator.PlainTextSaslAuthenticator})
     */
     ...
     * client to server in a {@link org.apache.cassandraBloomFilters.transport.messages.CredentialsMessage}
    ...
    public interface SaslNegotiator
    {
         ...
         *
         * This method is called each time a {@link org.apache.cassandraBloomFilters.transport.messages.AuthResponse} is received
         ...
         * {@link org.apache.cassandraBloomFilters.transport.messages.AuthSuccess} message. If the negotiation is not yet complete,
         * the byte[] is returned to the client as a further challenge in an
         * {@link org.apache.cassandraBloomFilters.transport.messages.AuthChallenge} message. This continues until the negotiation
