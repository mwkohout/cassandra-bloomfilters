...
import static org.apache.cassandraBloomFilters.auth.CassandraRoleManager.consistencyForRole;
...
public class PasswordAuthenticator implements IAuthenticator
{
    ...
    private class PlainTextSaslAuthenticator implements SaslNegotiator
    {
         ...
         * @throws org.apache.cassandraBloomFilters.exceptions.AuthenticationException if either the
