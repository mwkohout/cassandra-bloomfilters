...
import org.apache.cassandraBloomFilters.batchlog.BatchlogManagerMBean;
import org.apache.cassandraBloomFilters.db.ColumnFamilyStoreMBean;
import org.apache.cassandraBloomFilters.db.HintedHandOffManagerMBean;
import org.apache.cassandraBloomFilters.db.compaction.CompactionManager;
import org.apache.cassandraBloomFilters.db.compaction.CompactionManagerMBean;
import org.apache.cassandraBloomFilters.gms.FailureDetector;
import org.apache.cassandraBloomFilters.gms.FailureDetectorMBean;
import org.apache.cassandraBloomFilters.gms.Gossiper;
import org.apache.cassandraBloomFilters.gms.GossiperMBean;
import org.apache.cassandraBloomFilters.db.HintedHandOffManager;
import org.apache.cassandraBloomFilters.locator.EndpointSnitchInfoMBean;
import org.apache.cassandraBloomFilters.metrics.CassandraMetricsRegistry;
import org.apache.cassandraBloomFilters.metrics.TableMetrics.Sampler;
import org.apache.cassandraBloomFilters.metrics.StorageMetrics;
import org.apache.cassandraBloomFilters.metrics.TableMetrics;
import org.apache.cassandraBloomFilters.metrics.ThreadPoolMetrics;
import org.apache.cassandraBloomFilters.net.MessagingService;
import org.apache.cassandraBloomFilters.net.MessagingServiceMBean;
import org.apache.cassandraBloomFilters.service.CacheService;
import org.apache.cassandraBloomFilters.service.CacheServiceMBean;
import org.apache.cassandraBloomFilters.service.GCInspector;
import org.apache.cassandraBloomFilters.service.GCInspectorMXBean;
import org.apache.cassandraBloomFilters.service.StorageProxy;
import org.apache.cassandraBloomFilters.service.StorageProxyMBean;
import org.apache.cassandraBloomFilters.service.StorageServiceMBean;
import org.apache.cassandraBloomFilters.streaming.StreamManagerMBean;
import org.apache.cassandraBloomFilters.streaming.StreamState;
import org.apache.cassandraBloomFilters.streaming.management.StreamStateCompositeData;
...
import org.apache.cassandraBloomFilters.tools.nodetool.GetTimeout;
...
public class NodeProbe implements AutoCloseable
{
    ...
    private static final String ssObjName = "org.apache.cassandraBloomFilters.db:type=StorageService";
    ...
    {
        String cachePath = "org.apache.cassandraBloomFilters.db:type=Caches";
    ...
    public void setCacheCapacities(int keyCacheCapacity, int rowCacheCapacity, int counterCacheCapacity)
    {
        try
        {
            String keyCachePath = "org.apache.cassandraBloomFilters.db:type=Caches";
    ...
    public EndpointSnitchInfoMBean getEndpointSnitchInfoProxy()
    {
        try
        {
            return JMX.newMBeanProxy(mbeanServerConn, new ObjectName("org.apache.cassandraBloomFilters.db:type=EndpointSnitchInfo"), EndpointSnitchInfoMBean.class);
        }
        catch (MalformedObjectNameException e)
        {
            throw new RuntimeException(e);
    ...
    public ColumnFamilyStoreMBean getCfsProxy(String ks, String cf)
    {
        ...
        try
        {
            ...
            Set<ObjectName> beans = mbeanServerConn.queryNames(
                    new ObjectName("org.apache.cassandraBloomFilters.db:type=*" + type +",keyspace=" + ks + ",columnfamily=" + cf), null);
            ...
            switch(metricName)
            {
                ...
                case "Size":
                    return JMX.newMBeanProxy(mbeanServerConn,
                            new ObjectName("org.apache.cassandraBloomFilters.metrics:type=Cache,scope=" + cacheType + ",name=" + metricName),
    ...
    public Object getColumnFamilyMetric(String ks, String cf, String metricName)
    {
        try
        {
            ...
            ObjectName oName = new ObjectName(String.format("org.apache.cassandraBloomFilters.metrics:type=%s,keyspace=%s,scope=%s,name=%s", type, ks, cf, metricName));
            switch(metricName)
            {
    ...
    public CassandraMetricsRegistry.JmxTimerMBean getProxyMetric(String scope)
    {
        ...
        {
            return JMX.newMBeanProxy(mbeanServerConn,
                    new ObjectName("org.apache.cassandraBloomFilters.metrics:type=ClientRequest,scope=" + scope + ",name=Latency"),
    ...
    public Object getCompactionMetric(String metricName)
    {
        try
        {
            switch(metricName)
            {
                case "BytesCompacted":
                    return JMX.newMBeanProxy(mbeanServerConn,
                            new ObjectName("org.apache.cassandraBloomFilters.metrics:type=Compaction,name=" + metricName),
    ...
    public long getStorageMetric(String metricName)
    {
        ...
        {
            return JMX.newMBeanProxy(mbeanServerConn,
                    new ObjectName("org.apache.cassandraBloomFilters.metrics:type=Storage,name=" + metricName),
...
class ColumnFamilyStoreMBeanIterator implements Iterator<Map.Entry<String, ColumnFamilyStoreMBean>>
{
    ...
    {
        ObjectName query = new ObjectName("org.apache.cassandraBloomFilters.db:type=" + type +",*");
