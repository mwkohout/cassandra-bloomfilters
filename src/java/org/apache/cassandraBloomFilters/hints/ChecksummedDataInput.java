 ...
 *
 * Useful for {@link org.apache.cassandraBloomFilters.hints.HintsReader}, for example, where we must verify the CRC, yet don't want
 ...
 * so that {@link org.apache.cassandraBloomFilters.db.Mutation.MutationSerializer} doesn't blow up the heap when deserializing a
 * corrupted sequence by reading a huge corrupted length of bytes via
 * via {@link org.apache.cassandraBloomFilters.utils.ByteBufferUtil#readWithLength(java.io.DataInput)}.
 */
