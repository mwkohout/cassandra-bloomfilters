...
import static org.apache.cassandraBloomFilters.metrics.CassandraMetricsRegistry.Metrics;
...
public class ThreadPoolMetrics
{
    ...
    {
        String name = String.format("org.apache.cassandraBloomFilters.metrics:type=ThreadPools,path=%s,scope=%s,name=%s", jmxPath, poolName, metricName);
    ...
    public static Multimap<String, String> getJmxThreadPools(MBeanServerConnection mbeanServerConn)
    {
        try
        {
            ...
            Set<ObjectName> threadPoolObjectNames = mbeanServerConn.queryNames(new ObjectName("org.apache.cassandraBloomFilters.metrics:type=ThreadPools,*"),
                                                                               null);
