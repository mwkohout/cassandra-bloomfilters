...
import org.apache.cassandraBloomFilters.auth.IAuthenticator;
import org.apache.cassandraBloomFilters.auth.IAuthorizer;
import org.apache.cassandraBloomFilters.auth.IRoleManager;
...
public class FBUtilities
{
    ...
    public static IPartitioner newPartitioner(String partitionerClassName) throws ConfigurationException
    {
        if (!partitionerClassName.contains("."))
            partitionerClassName = "org.apache.cassandraBloomFilters.dht." + partitionerClassName;
    ...
    public static IAuthorizer newAuthorizer(String className) throws ConfigurationException
    {
        if (!className.contains("."))
            className = "org.apache.cassandraBloomFilters.auth." + className;
