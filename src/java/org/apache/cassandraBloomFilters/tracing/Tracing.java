...
import org.apache.cassandraBloomFilters.concurrent.ExecutorLocal;
...
public abstract class Tracing implements ExecutorLocal<TraceState>
{
    ...
    /**
     * Called from {@link org.apache.cassandraBloomFilters.net.OutboundTcpConnection} for non-local traces (traces
