...
import org.apache.cassandraBloomFilters.cache.AutoSavingCache.CacheSerializer;
...
import org.apache.cassandraBloomFilters.db.partitions.CachedBTreePartition;
...
public class CacheService implements CacheServiceMBean
{
    ...
    public static final String MBEAN_NAME = "org.apache.cassandraBloomFilters.db:type=Caches";
    ...
    private AutoSavingCache<RowCacheKey, IRowCacheEntry> initRowCache()
    {
        ...
        String cacheProviderClassName = DatabaseDescriptor.getRowCacheSizeInMB() > 0
                                        ? DatabaseDescriptor.getRowCacheClassName() : "org.apache.cassandraBloomFilters.cache.NopCacheProvider";
        try
        {
