...
import org.apache.cassandraBloomFilters.net.CompactEndpointSerializationHelper;
import org.apache.cassandraBloomFilters.net.MessagingService;
import org.apache.cassandraBloomFilters.utils.UUIDSerializer;

/**
 * StreamInitMessage is first sent from the node where {@link org.apache.cassandraBloomFilters.streaming.StreamSession} is started,
 * to initiate corresponding {@link org.apache.cassandraBloomFilters.streaming.StreamSession} on the other side.
 */
