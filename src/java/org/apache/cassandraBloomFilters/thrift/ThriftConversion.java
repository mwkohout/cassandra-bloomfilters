...
import org.apache.cassandraBloomFilters.db.CompactTables;
import org.apache.cassandraBloomFilters.db.LegacyLayout;
import org.apache.cassandraBloomFilters.db.WriteType;
...
{
    public static org.apache.cassandraBloomFilters.db.ConsistencyLevel fromThrift(ConsistencyLevel cl)
    {
        switch (cl)
        {
            case ANY: return org.apache.cassandraBloomFilters.db.ConsistencyLevel.ANY;
            case ONE: return org.apache.cassandraBloomFilters.db.ConsistencyLevel.ONE;
            case TWO: return org.apache.cassandraBloomFilters.db.ConsistencyLevel.TWO;
            case THREE: return org.apache.cassandraBloomFilters.db.ConsistencyLevel.THREE;
            case QUORUM: return org.apache.cassandraBloomFilters.db.ConsistencyLevel.QUORUM;
            case ALL: return org.apache.cassandraBloomFilters.db.ConsistencyLevel.ALL;
            case LOCAL_QUORUM: return org.apache.cassandraBloomFilters.db.ConsistencyLevel.LOCAL_QUORUM;
            case EACH_QUORUM: return org.apache.cassandraBloomFilters.db.ConsistencyLevel.EACH_QUORUM;
            case SERIAL: return org.apache.cassandraBloomFilters.db.ConsistencyLevel.SERIAL;
            case LOCAL_SERIAL: return org.apache.cassandraBloomFilters.db.ConsistencyLevel.LOCAL_SERIAL;
            case LOCAL_ONE: return org.apache.cassandraBloomFilters.db.ConsistencyLevel.LOCAL_ONE;
        }
        throw new AssertionError();
    }

    public static ConsistencyLevel toThrift(org.apache.cassandraBloomFilters.db.ConsistencyLevel cl)
    {
        switch (cl)
        {
    ...
    public static UnavailableException toThrift(org.apache.cassandraBloomFilters.exceptions.UnavailableException e)
    {
        return new UnavailableException();
    }

    public static AuthenticationException toThrift(org.apache.cassandraBloomFilters.exceptions.AuthenticationException e)
    {
    ...
    throws org.apache.cassandraBloomFilters.exceptions.InvalidRequestException, ConfigurationException
    {
    ...
    throws org.apache.cassandraBloomFilters.exceptions.InvalidRequestException
    {
        switch (thriftColumnType.toLowerCase())
        {
            ...
            default: throw new org.apache.cassandraBloomFilters.exceptions.InvalidRequestException("Invalid column type " + thriftColumnType);
        }
    }
    ...
    private static void applyImplicitDefaults(org.apache.cassandraBloomFilters.thrift.CfDef cf_def)
    {
        if (!cf_def.isSetComment())
            cf_def.setComment("");
    ...
    public static ColumnDef toThrift(CFMetaData cfMetaData, ColumnDefinition column)
    {
        ...
        if (matchedIndex != null)
        {
            cd.setIndex_type(org.apache.cassandraBloomFilters.thrift.IndexType.valueOf(matchedIndex.kind.name()));
