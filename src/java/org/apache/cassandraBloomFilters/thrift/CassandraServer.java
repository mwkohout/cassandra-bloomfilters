...
import org.apache.cassandraBloomFilters.metrics.ClientMetrics;
import org.apache.cassandraBloomFilters.scheduler.IRequestScheduler;
...
import org.apache.cassandraBloomFilters.service.*;
import org.apache.cassandraBloomFilters.service.pager.QueryPagers;
...
public class CassandraServer implements Cassandra.Iface
{
    ...
    protected PartitionIterator read(List<SinglePartitionReadCommand> commands, org.apache.cassandraBloomFilters.db.ConsistencyLevel consistency_level, ClientState cState)
    throws org.apache.cassandraBloomFilters.exceptions.InvalidRequestException, UnavailableException, TimedOutException
    {
        try
        {
    ...
    private Map<ByteBuffer, List<ColumnOrSuperColumn>> getSlice(List<SinglePartitionReadCommand> commands, boolean subColumnsOnly, int cellLimit, org.apache.cassandraBloomFilters.db.ConsistencyLevel consistency_level, ClientState cState)
    throws org.apache.cassandraBloomFilters.exceptions.InvalidRequestException, UnavailableException, TimedOutException
    {
    ...
    throws org.apache.cassandraBloomFilters.exceptions.InvalidRequestException, UnavailableException, TimedOutException
    {
        ...
        org.apache.cassandraBloomFilters.db.ConsistencyLevel consistencyLevel = ThriftConversion.fromThrift(consistency_level);
    ...
    throws RequestValidationException, UnavailableException, TimedOutException
    {
        ...
        if (metadata.isView())
            throw new org.apache.cassandraBloomFilters.exceptions.InvalidRequestException("Cannot modify Materialized Views directly");
        ...
        {
            throw new org.apache.cassandraBloomFilters.exceptions.InvalidRequestException("missing mandatory super column name for super CF " + column_parent.column_family);
        }
        ...
        org.apache.cassandraBloomFilters.db.Mutation mutation;
        try
        {
            ...
            mutation = new org.apache.cassandraBloomFilters.db.Mutation(update);
        }
    ...
    throws InvalidRequestException, UnavailableException, TimedOutException
    {
        ...
        try
        {
            ...
            ThriftValidation.validateKey(metadata, key);
            if (metadata.isSuper())
                throw new org.apache.cassandraBloomFilters.exceptions.InvalidRequestException("CAS does not support supercolumns");
    ...
    throws RequestValidationException, InvalidRequestException
    {
        ...
        for (Map.Entry<ByteBuffer, Map<String, List<Mutation>>> mutationEntry: mutation_map.entrySet())
        {
            ...
            org.apache.cassandraBloomFilters.db.Mutation standardMutation = null;
            org.apache.cassandraBloomFilters.db.Mutation counterMutation = null;
            ...
            for (Map.Entry<String, List<Mutation>> columnFamilyMutations : columnFamilyToMutations.entrySet())
            {
                ...
                if (metadata.isCounter())
                {
                    counterMutation = counterMutation == null ? new org.apache.cassandraBloomFilters.db.Mutation(keyspace, dk) : counterMutation;
                    mutation = counterMutation;
                }
                else
                {
                    standardMutation = standardMutation == null ? new org.apache.cassandraBloomFilters.db.Mutation(keyspace, dk) : standardMutation;
            ...
            if (counterMutation != null && !counterMutation.isEmpty())
            {
                if (allowCounterMutations)
                    ...
                    throw new org.apache.cassandraBloomFilters.exceptions.InvalidRequestException("Counter mutations are not allowed in atomic batches");
            }
        }
    ...
    throws RequestValidationException, UnavailableException, TimedOutException
    {
        ...
        org.apache.cassandraBloomFilters.db.Mutation mutation = new org.apache.cassandraBloomFilters.db.Mutation(update);
    ...
    throws UnavailableException, TimedOutException, org.apache.cassandraBloomFilters.exceptions.InvalidRequestException
    {
    ...
    public void login(AuthenticationRequest auth_request) throws TException
    {
        ...
        catch (org.apache.cassandraBloomFilters.exceptions.AuthenticationException e)
        {
            throw ThriftConversion.toThrift(e);
        }
    }
    ...
    throws InvalidRequestException, SchemaDisagreementException, TException
    {
        ...
        try
        {
            ...
            CFMetaData metadata = ThriftValidation.validateColumnFamily(keyspace, column_family);
            if (metadata.isView())
                throw new org.apache.cassandraBloomFilters.exceptions.InvalidRequestException("Cannot drop Materialized Views from Thrift");
    ...
    public void truncate(String cfname) throws InvalidRequestException, UnavailableException, TimedOutException, TException
    {
        ...
        try
        {
            ...
            if (metadata.isView())
                throw new org.apache.cassandraBloomFilters.exceptions.InvalidRequestException("Cannot truncate Materialized Views");
        ...
        catch (org.apache.cassandraBloomFilters.exceptions.UnavailableException e)
        {
            throw ThriftConversion.toThrift(e);
        }
        catch (TimeoutException e)
            ...
            throws InvalidRequestException, UnavailableException, TimedOutException
    {
        ...
        try 
        {
            ...
            if (metadata.isSuper())
                throw new org.apache.cassandraBloomFilters.exceptions.InvalidRequestException("get_multi_slice does not support super columns");
            ThriftValidation.validateColumnParent(metadata, request.getColumn_parent());
            org.apache.cassandraBloomFilters.db.ConsistencyLevel consistencyLevel = ThriftConversion.fromThrift(request.getConsistency_level());
            consistencyLevel.validateForRead(keyspace);
     ...
     * @param columnSlice
     */
    private static void fixOptionalSliceParameters(org.apache.cassandraBloomFilters.thrift.ColumnSlice columnSlice) {
