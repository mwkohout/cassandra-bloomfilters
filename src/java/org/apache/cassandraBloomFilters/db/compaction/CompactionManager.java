...
import org.apache.cassandraBloomFilters.cache.AutoSavingCache;
import org.apache.cassandraBloomFilters.concurrent.DebuggableThreadPoolExecutor;
import org.apache.cassandraBloomFilters.concurrent.JMXEnabledThreadPoolExecutor;
...
import org.apache.cassandraBloomFilters.db.compaction.CompactionInfo.Holder;
...
import org.apache.cassandraBloomFilters.db.view.ViewBuilder;
...
import org.apache.cassandraBloomFilters.io.sstable.IndexSummaryRedistribution;
import org.apache.cassandraBloomFilters.io.sstable.SSTableRewriter;
import org.apache.cassandraBloomFilters.io.sstable.SnapshotDeletingTask;
...
{
    public static final String MBEAN_OBJECT_NAME = "org.apache.cassandraBloomFilters.db:type=CompactionManager";
     ...
     * the {@link org.apache.cassandraBloomFilters.io.sstable.metadata.StatsMetadata#repairedAt} field.
     */
