 ...
 */
package org.apache.cassandraBloomFilters.db.partitions;
...
public interface CachedPartition extends Partition, IRowCacheEntry
{
     ...
     *
     * See {@link org.apache.cassandraBloomFilters.db.ColumnFamilyStore#isFilterFullyCoveredBy} to see why we need this.
     *
     ...
     * {@link org.apache.cassandraBloomFilters.db.filter.DataLimits#hasEnoughLiveData} as an optimization.
     *
