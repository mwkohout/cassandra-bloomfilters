...
public class TemporalRow
{
    ...
    public ByteBuffer clusteringValue(ColumnDefinition definition, Resolver resolver)
    {
        ...
        else
        {
            ...
            Collection<org.apache.cassandraBloomFilters.db.rows.Cell> val = values(definition, resolver);
            if (val != null && val.size() == 1)
            {
                org.apache.cassandraBloomFilters.db.rows.Cell cell = Iterables.getOnlyElement(val);
    ...
    public Collection<org.apache.cassandraBloomFilters.db.rows.Cell> values(ColumnDefinition definition, Resolver resolver)
    {
        ...
        Collection<org.apache.cassandraBloomFilters.db.rows.Cell> value = new ArrayList<>();
