...
public class ViewBuilder extends CompactionInfo.Holder
{
    ...
    public void run()
    {
        ...
        Token lastToken;
        Function<org.apache.cassandraBloomFilters.db.lifecycle.View, Iterable<SSTableReader>> function;
        if (buildStatus == null)
        {
            baseCfs.forceBlockingFlush();
            function = org.apache.cassandraBloomFilters.db.lifecycle.View.select(SSTableSet.CANONICAL);
        ...
        {
            function = new Function<org.apache.cassandraBloomFilters.db.lifecycle.View, Iterable<SSTableReader>>()
            {
                @Nullable
                public Iterable<SSTableReader> apply(org.apache.cassandraBloomFilters.db.lifecycle.View view)
                {
                    Iterable<SSTableReader> readers = org.apache.cassandraBloomFilters.db.lifecycle.View.select(SSTableSet.CANONICAL).apply(view);
                    if (readers != null)
