...
import org.apache.cassandraBloomFilters.io.util.DataOutputBufferFixed;
import org.apache.cassandraBloomFilters.metrics.CommitLogMetrics;
...
import static org.apache.cassandraBloomFilters.db.commitlog.CommitLogSegment.*;
import static org.apache.cassandraBloomFilters.utils.FBUtilities.updateChecksum;
import static org.apache.cassandraBloomFilters.utils.FBUtilities.updateChecksumInt;
...
public class CommitLog implements CommitLogMBean
{
    ...
    private static CommitLog construct()
    {
        ...
        try
        {
            mbs.registerMBean(log, new ObjectName("org.apache.cassandraBloomFilters.db:type=Commitlog"));
        }
        catch (Exception e)
        {
